# Este desafio tem como objetivo, criar um site "quase" completo, com tudo o que foi estudado até aqui no curso de HTML Developer. Os temas que deverão ser abordados são:
- Formulários
...
Todas as páginas terão que seguir um padrão pré-definido. Como não aprendemos sobre CSS ainda, vamos utilizar um template pronto para auxiliar. 
